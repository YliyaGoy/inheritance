...
class Room:
    ...
    def __private_method(self): # метод для вычисления периметра комнаты
        print("Периметр комнаты:")
...
class OneRoomFlat:
    def __init__(self, room, kitchen_area, floor):
        # Конструктор класса
        self.room = room
    ...
    def set_room_area(self,room): # установка значения
        self.room.area = room.area
...
class PublicOneRoomFlat(OneRoomFlat):
    def __init__(self, room, kitchen_area, floor, city_name): # конструктор
        super().__init__(room, kitchen_area, floor)
...
class _StudioApartment:
    def __init__(self, room, kitchen_area, floor, studio_name):
        # Конструктор класса
        self.room = room
        self.kitchen_area = kitchen_area
        self.floor = floor
...
def room_menu(room_obj): # меню для работы с комнатой
    while True:
        ...
        print("8. Вывести периметр комнтаы")
